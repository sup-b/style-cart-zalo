    ...
    <div className="py-6">
      ...
      <div className="flex items-center justify-between px-4 mb-4">
        <div>
          ...
          <p className="font-body text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-0.5">
            Weekly Best
          </p>
        </div>
        {/* Countdown */}
        <div className="flex items-center gap-1">
          {[pad(hours), pad(minutes), pad(seconds)].map((val, i) => (
            <span key={i} className="flex items-center gap-1">
              <span className="bg-foreground text-background font-body text-xs font-bold px-1.5 py-1 rounded-sm min-w-[28px] text-center">
                {val}
              </span>
          ...
          return (
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-lg bg-secondary">
                ...
                />
                {discount && (
                  <span className="absolute top-2 left-2 bg-foreground text-background px-1.5 py-0.5 font-body text-[10px] font-bold rounded-sm">
                    -{discount}%
                  </span>
                )}
              </div>
              <div className="mt-2 space-y-0.5">
                ...
                <div className="flex items-center gap-1.5">
                  <span className="font-body text-xs font-bold text-accent-warm">
